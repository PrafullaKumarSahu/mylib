                                                                ...
                                                                <div class="col-xs-6 text-center">
                                                                    <?php
                                                                        if(isForm())
                                                                        {
                                                                            ...
                                                                            {
                                                                                $library->createSubCategories($category, $name, $description, $date);
                                                                    ...
                                                                    <form class="form-horizontal" action="" method="post">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="col-sm-3 control-label" for="input-id-1">Sub of:</label>
                                                                            <div class="col-sm-5">
                                                                                <select class="form-control" name="category">
                                                                                    <?php
                                                                                        $sub = $library->subCategories();
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-sm-offset-3 col-sm-5">
                                                                                <button type="submit" class="btn btn-sm btn-primary">Create Sub-Category</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
