                                                            ...
                                                            <div class="row m-t-xl">
                                                                ...
                                                                <div class="col-xs-6 text-center">
                                                                    <?php
                                                                        if(isForm())
                                                                        {
                                                                            $subcategory = inputValue('sub-category');
                                                                            $library->deleteSubCategory($subcategory);
                                                                        }
                                                                    ?>
                                                                    <?php
                                                                        if($message->get())
                                                                    ...
                                                                    <form class="form-horizontal" action="" method="post">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-sm-offset-3 col-sm-5">
                                                                                <button type="submit" class="btn btn-sm btn-primary">Delete Sub-Category</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
